...
Contributors: reaim
Donate link: https://reaim.me
Tags: chrome, firefox, push, push notifications, push notification, chrome push, firefox push, notification, notifications, web push, notify, android notifications, android notification, mobile notification, mobile notifications, mobile, desktop notification, desktop notifications, push messages, reaim
...
Increase user engagement and drive more traffic to your WordPress site with ReAim Push.

== Description ==

[ReAim Push](https://reaim.me) is an easy way to increase user engagement. Use ReAim to send visitors targeted push notifications so they keep coming back. It takes just a few clicks to install.
...
Contact support@reaim.me if you have any questions.

= Features =
* **Supports Chrome** (Desktop & Android), **Microsoft Edge** (Desktop & Android), **Opera** (Desktop & Android) and **Firefox** (Desktop & Android) on HTTPS sites.
...
1. Install ReAim from the WordPress.org plugin directory or by uploading the ReAim plugin folder to your wp-content/plugins directory.
